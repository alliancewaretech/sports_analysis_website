...
class PostgresSqlWriter:
    ...
    def write_table(self,df,table,schema=None,if_exists="append",index=False,dtype=None,chunksize=10000):
        df.to_sql(table, con=self.conn, if_exists=if_exists,schema=schema,index=False,dtype=dtype)
        return df
