...
class S3DataReader:
    ...
    def read_s3_csv(self,bucket,filepath,sep=",",s3=None,s3_client=None,verbose=False,**args):
        """
        @param filepath:
        @type filepath:
        @param bucket:
    ...
    def read_s3_json(self,bucket,filepath,s3=None,s3_client=None,verbose=False,**args):
        """
        @param filepath:
        @type filepath:
        @param bucket:
